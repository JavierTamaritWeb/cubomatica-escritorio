<div align="center">
  ...
  <p>
    <a href="#versionado"><img src="https://img.shields.io/badge/versi%C3%B3n-4.10.0-2B7BB9" alt="Versión 4.10.0"></a>
    ...
    <a href="#tests"><img src="https://img.shields.io/badge/tests-79%20passing-2EA043" alt="79 tests"></a>
  </p>
  <br>
...
| | |
|---|---|
| **Versión de la app** | **4.10.0**, declarada en `pyproject.toml` y `Cubomatica.spec` |
| **Versión del juego** | `CB.VERSION`, dentro del bundle web (hoy 3.9.0) |
